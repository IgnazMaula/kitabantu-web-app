                          ...
                          <div className='relative flex'>
                            <Popover.Button
                              className={classNames(
                                open ? 'border-red-600 text-red-600' : 'border-transparent text-gray-700 hover:text-gray-800',
              ...
              <div className='ml-auto flex items-center'>
                ...
                <div className='ml-4 flow-root lg:ml-6'>
                  <a href='#' className='group -m-2 p-2 flex items-center'>
                    <ChatAlt2Icon className='flex-shrink-0 h-6 w-6 text-gray-400 group-hover:text-gray-500' aria-hidden='true' />
